...
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/rapidapi-test/_page.svelte.js')).default;
export const universal = {
  "prerender": true,
  "ssr": false
};
export const universal_id = "src/routes/rapidapi-test/+page.ts";
...
export const stylesheets = ["_app/immutable/assets/17.B_IlzWRt.css"];
export const fonts = [];
