...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_class_variance_authority: string;
	...
	export const npm_package_dependencies__ai_sdk_openai: string;
	export const npm_package_dependencies__ai_sdk_svelte: string;
	export const npm_package_dependencies__dvcol_neo_svelte: string;
	export const npm_package_dependencies__radix_ui_colors: string;
	export const npm_package_dependencies__studio_freight_lenis: string;
	...
	export const npm_package_scripts_lint_check: string;
	...
	export const npm_package_scripts_typecheck_watch: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_class_variance_authority: string;
		...
		npm_package_dependencies__ai_sdk_openai: string;
		npm_package_dependencies__ai_sdk_svelte: string;
		npm_package_dependencies__dvcol_neo_svelte: string;
		npm_package_dependencies__radix_ui_colors: string;
		npm_package_dependencies__studio_freight_lenis: string;
		...
		npm_package_scripts_lint_check: string;
		...
		npm_package_scripts_typecheck_watch: string;
